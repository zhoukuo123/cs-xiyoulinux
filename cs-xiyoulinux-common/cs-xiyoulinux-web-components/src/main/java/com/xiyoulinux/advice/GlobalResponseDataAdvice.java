...
public class GlobalResponseDataAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object o, MethodParameter methodParameter,
        ...
        if (StringUtils.contains(serverHttpRequest.getURI().getPath(),"api-docs")
                || StringUtils.contains(serverHttpRequest.getURI().getPath(),"swagger-resources")){
            return o;
        }
        System.out.println(serverHttpRequest.getURI().getPath() +"global");
        // 定义最终的返回对象,默认是正确的
